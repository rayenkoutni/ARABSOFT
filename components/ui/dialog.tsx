...
<<<<<<< HEAD
      className={cn('min-w-0 whitespace-normal text-lg leading-tight font-semibold', className)}
=======
...
<<<<<<< HEAD
      className={cn('text-muted-foreground min-w-0 whitespace-normal text-sm', className)}
=======
